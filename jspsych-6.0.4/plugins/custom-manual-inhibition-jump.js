...
jsPsych.plugins["manual-inhibition-jump"] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    if (trial.runTrial){
      ...
      display_element.querySelector('#button-central').addEventListener('touchstart', onCentralTouch);
      display_element.querySelector('#button-central').addEventListener('touchend', onCentralLift);
      display_element.querySelector('#button-side').addEventListener('touchstart', onSideTouch);
