...
jsPsych.plugins["manual-inhibition-serial"] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
      ...
      if (trial.runTrial) {
          ...
          for (var i = 0; i < trial.buttonsInvisible.length; i++) {
              display_element.querySelector('#invisible-button-' + i).addEventListener('touchstart', onTouch)
              display_element.querySelector('#invisible-button-' + i).addEventListener('touchend', onRelease)
          };
